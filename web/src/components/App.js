...
import {
  authenticate as authenticateSpotify,
  fetchPlayStatus
} from "../util/spotify";
import {
  fetchLightStatus,
...
class App extends Component {
    ...
    <Card title={"Controls"}>
      <div className="columns">
        <div className="column is-narrow">
          <a className={"button is-success"} onClick={this.loginWithSpotify}>
            Connect Spotify
          </a>
        </div>
        <div className="column is-narrow">
        ...
        <div className="column is-narrow">
          <a className={"button"} onClick={this.handleShuffle}>
            Shuffle Lights
          </a>
        </div>
        <div className="column is-narrow">
          <a className={"button is-primary"} onClick={this.toggleLightMatching}>
            {this.state.config.lightMatching ? "Disable" : "Enable"} light
            matching
          </a>
        </div>
      </div>
  ...
  renderSpotifyInfo = () => (
    <Card title={"Spotify"}>
      <SpotifyInfoCard status={this.state.spotify} />
    </Card>
  );
      ...
      <div>
        ...
        <div className="content-wrapper">
          <div className="content-container">
            {this.renderControls()}
            <Card title={"Fun"}>
              <a className={"button is-large"} onClick={this.handleShuffle}>
                Shuffle Lights
              </a>
            </Card>
